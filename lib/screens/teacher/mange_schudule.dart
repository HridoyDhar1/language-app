...
//       child: ListTile(
//         title: Text("${schedule['name']} - ${schedule['description']}"),
//         subtitle: Text(
//           "$dateStr at $timeStr\n${schedule['location']} - BDT ${schedule['price']}",
//         ),
//         trailing: IconButton(
//           icon: const Icon(Icons.delete, color: Colors.red),
//           onPressed: () => scheduleController.removeSchedule(schedule),
//         ),
//       ),
//     );
//   }
...
//                       _buildScheduleCard(scheduleController.schedules[index]),
//                 );
//               }),
//             ),
//           ],
...
import 'package:languageapp/screens/teacher/scheul_controller.dart'; // Import the model
